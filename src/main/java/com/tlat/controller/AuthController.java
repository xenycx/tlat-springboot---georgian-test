...
public class AuthController {
	...
	public String addUser(
		...
		if (isStudentRole(userDto) && (userDto.getPassword() == null || userDto.getPassword().isEmpty())) {
			userDto.setPassword(java.util.UUID.randomUUID().toString() + "aA1!"); // random strong password
		}
	...
	public String updateUserById(
		...
		if (isStudentRole(updatedUserDto) && (updatedUserDto.getPassword() == null || updatedUserDto.getPassword().isEmpty())) {
			updatedUserDto.setPassword(java.util.UUID.randomUUID().toString() + "aA1!"); // random strong password just to pass validation
		}
